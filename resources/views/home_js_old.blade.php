...
<section class="section-container py-14 md:py-20">
  <div class="relative overflow-hidden rounded-3xl bg-gradient-to-r from-primary to-red-400 p-8 md:p-12 lg:p-16 text-white">
    ...
    <div class="relative z-10 flex flex-col md:flex-row items-center justify-between gap-6">
      ...
      <a href="{{ route('products.index') }}" class="shrink-0 inline-flex items-center gap-2 px-8 py-4 rounded-full bg-white text-primary font-bold text-sm hover:bg-white/90 transition-colors shadow-lg">
